//modified CupertinoSlidingSegmentedControl
...
const Radius _kThumbRadius = Radius.circular(26.93); //changed by delay
...
const Color _kSeparatorColor = Color.fromRGBO(0, 0, 0, 0); //changed by delay
...
const double _kCornerRadius = 28; //changed by delay
